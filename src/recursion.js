...
var arraySum = function(array) {
  return array.reduce(function(acc, cur) {
    return acc + (Array.isArray(cur) ? arraySum(cur) : cur);
  }, 0);
 };
...
var reverse = function(string) {
  return string === '' ? '' : reverse(string.slice(1)) + string.charAt(0);
};
...
var fizzBuzz = function(n) {
  ...
  return fizzBuzz(n-1).concat([typeof(m) === 'number' ? n.toString() : m]);
};
...
var countKeysInObj = function(obj, key) {
  return Object.keys(obj).reduce(function(acc, cur) {
    if (typeof(obj[cur]) === 'object') {
      ...
      return acc + countKeysInObj(obj[cur], key);
    };
    return cur === key ? acc + 1 : acc;
  }, 0);
};
...
var countValuesInObj = function(obj, value) {
  return Object.values(obj).reduce(function(acc, cur) {
    if (typeof(cur) === 'object') {
      return acc + countValuesInObj(cur, value);
    }
...
// var obj = {'e':{'x':'y'}, 't':{'p':{'y':'r'}, 'r':{'e':'r'}}, 'y':'e'}
var replaceKeysInObj = function(obj, oldKey, newKey) {
    ...
    for (var i = 0; i < keys.length; i++) {
      ...
      if (typeof(obj[key]) === 'object' && key === oldKey) {
        ...
        delete obj[key];
      } else if (typeof(obj[key]) === 'object' && key !== oldKey) {
...
var alternateSign = function(array) {
  ...
  if (array.length % 2 === 0 && array[array.length - 1] > 0 || array.length % 2 === 1 && array[array.length - 1] < 0) {
    array[array.length - 1] = -array[array.length - 1];
  }
  var newArr = alternateSign(array.slice(0, -1));
...
var numToText = function(str) {
  ...
  return str[0].toString() + ' ' + numToText(str.slice(1).join(' '));
};
